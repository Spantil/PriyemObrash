<?php
    ...
    if ($error != '') {
        ...
        exit('<meta http-equiv="refresh" content="0; url=../appeal.php" />'); // Выполнение дальнейших комант отменяется и идет переадрессация
    }
    ...
    $subjec = "=?utf-8?B?".base64_encode("Предложение от гражданина")."?="; // Оглавление сообщения
    ...
    header('Location: ../appeal.php'); // возвращение на страницу с формой
?>
