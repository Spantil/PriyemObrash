...
<html lang="ru">
    ...
    <?php
        require "blocks/header.php" // Подключает хедер
    ?>
    ...
    <main>
        ...
        <div class="container d-flex justify-content-center mb-4">
            <div class="w-0 ">
                <img class="rounded mx-auto d-block" src="img\1.1.png" alt="" width="90%">
                <div class="container mt-3 mb-4 text-center ">
                    <h3>Введите текст вашего обращения</h3>
                </div>
                
                <form action="message/mess1.php" method="post" class="m-5">
                    <div class="text-danger mb-3 text-center text-wrap">
                        <?php
                            error_reporting(0);
                            echo htmlspecialchars($_COOKIE["Err3"]); // Отображает Ошибку
                        ?>
                    </div>   
                    <?php
                        if (!empty($_COOKIE['Nam'])): // Отображает сообщение ниже 
                    ?>  
    ...
    <?php
        require "blocks/footer.php" // Подключает футер
    ?>
